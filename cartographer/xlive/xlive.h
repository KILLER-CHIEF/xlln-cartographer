...
extern tXShowGuideUI XShowGuideUI;
...
typedef DWORD(WINAPI *tXLLNOnlineSetMode)(DWORD *onlineMode);
extern tXLLNOnlineSetMode XLLNOnlineSetMode;
extern BOOL OnlineModeFunctional;
